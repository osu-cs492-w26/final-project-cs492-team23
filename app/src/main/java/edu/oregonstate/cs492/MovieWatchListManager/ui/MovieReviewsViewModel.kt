...
import edu.oregonstate.cs492.MovieWatchListManager.data.MovieReviewsRepository
import edu.oregonstate.cs492.MovieWatchListManager.data.Review
...
class MovieReviewsViewModel: ViewModel() {
    private val repository = MovieReviewsRepository(TMDBService.Companion.create())
